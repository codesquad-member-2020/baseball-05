...
public class SelectDAO {
    ...
    private Game findGameById(Long matchesId) {
        String sql = "SELECT g.id FROM game g WHERE g.match_id = ?";
    ...
    private List<Inning> findAllInnings(Long gameId) {
        ...
        RowMapper<Inning> inningRowMapper = (rs, rowNum) -> {
            ...
            inning.setHalf(rs.getString("i.half"));
            return inning;
        };
    ...
    private Matches findMatchesById(Long matchesId) {
        String sql = "SELECT m.id, user_a, user_b, m.home_team, m.away_team FROM matches m WHERE m.id = ?";

        RowMapper<Matches> matchesRowMapper = (rs, rowNum) -> {
            Matches matches = new Matches();
            matches.setId(rs.getLong("id"));
            matches.setAUserId(rs.getLong("user_a"));
            matches.setBUserId(rs.getLong("user_b"));
